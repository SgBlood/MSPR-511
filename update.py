...
def compare_versions(local_version, latest_version):
    ...
    try:
        # Conversion en tuples (ex: "1.0.1" -> (1, 0, 1))
...
def update_application():
    """Met à jour l'application via Git."""
    ...
    try:
        ...
        print("\n✅ Mise à jour terminée. Redémarrez l'application.")
        messagebox.showinfo("Mise à jour", "✅ Mise à jour terminée ! Redémarrez l'application.")
